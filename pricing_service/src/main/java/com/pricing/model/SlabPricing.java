...
@Data
@Entity
@Table(name = "slab_pricing", schema = "pricing_schema")
public class SlabPricing {
	...
	@Column(name = "per_km_pricing", nullable = false, columnDefinition = "NUMERIC(10, 2)")
	private BigDecimal perKmPricing;
